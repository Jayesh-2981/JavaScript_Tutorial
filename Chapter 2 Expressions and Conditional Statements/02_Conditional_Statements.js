...
! This is a valid age
* Explanation: 
* Since age is 17, it satisfies the condition age > 0.
*/
...
* Explanation: 
* Since age is 17, it is less than 18, so the else block is executed.
*/
...
* Explanation: 
* Since age is 17, it satisfies the condition (age < 18 && age >= 9), so this block is executed.
*/
...
! You can not drive
* Explanation: 
* The ternary operator checks if age is less than 18, and since it is, "not drive" is printed.
*/
